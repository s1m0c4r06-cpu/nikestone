...
const CONFIG = {
  ...
  FORM_ENDPOINT: "https://formsubmit.co/ajax/massimoangelino23@gmail.com",
...
form.addEventListener("submit", async e => {
  ...
  // Config check
  if (!CONFIG.FORM_ENDPOINT || CONFIG.FORM_ENDPOINT.includes("YOUR_FORM_ID") || CONFIG.FORM_ENDPOINT.includes("YOUR_")){
  ...
  payload._subject = "Nuova richiesta preventivo Nikestone";
